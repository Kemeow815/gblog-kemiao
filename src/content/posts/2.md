...
pubDate: "2025-04-14 08:08:49"
category: "technology"
tags: ["教程, Waline"]
banner: "https://i1.wp.com/dev.ruom.top/i/2025/04/14/073842.webp"
selected: true
---
...
2. 创建`<script>`标签使用来自
`https://unpkg.com/@waline/client@v3/dist/waline.js`的`init()`函数初始化，并传入必要的`el`与`serverURL`选项。
